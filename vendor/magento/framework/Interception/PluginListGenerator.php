    ...
    public function write(array $scopes): void
    {
        foreach ($scopes as $scope) {
            ...
            if (false === isset($this->loadedScopes[$scope])) {
				...
				# 1) "How to fix «file_put_contents(generated/metadata/primary|global|plugin-list.php): failed to open stream:
				# No such file or directory in lib\internal\Magento\Framework\Interception\PluginListGenerator.php on line 414»
